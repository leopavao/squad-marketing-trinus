...
8.1. Respeitar a **regra das três camadas**. Invariante (tokens, grade, escala de canvas, logo, dourado, universo fotográfico, locação única) não muda sem decisão do humano. Biblioteca (`marca/referencias/`) cresce a cada aprovação e serve de repertório. Livre (tese, copy, dado, narrativa, enquadramento) é onde a criatividade trabalha. Se a peça parecer pedir algo da camada invariante, pare antes de produzir e pergunte. Ver `marca/memory/memoria-criativa.md` e `marca/referencias/README.md`.
